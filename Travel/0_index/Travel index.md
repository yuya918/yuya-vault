## Purpose
旅で見た都市・文化・人の空気を記録し、ショート動画・ロング動画・SNS投稿へ展開するための制作拠点。  
単なる観光記録ではなく、「自分の認識がどう変わったか」を軸に、映像と言葉を整理する。

## Concept
Cities. Culture. People.

旅先で見た景色そのものよりも、そこで暮らす人々の表情、社会の空気、街のリズムから、自分が何を感じたかを残す。  
映像は記録であり、言葉は認識の変化を伝えるためのもの。

## Core Style
- 観光紹介ではなく、観察と思考の記録
- 国や都市の説明より、自分の認識変化を中心にする
- 具体的な人の動き、表情、街の空気から入る
- 結論を急がず、映像で伝わる部分は語りすぎない
- 日本との比較は、制度や経済の話より「空気の違い」で表現する
- 成熟社会 / 成長社会のような抽象語は、観察のあとに置く
...
### Chongqing Short
- Lessons Learned：[[Chongqing Learning]]
- Focus：
  - 北京・上海・深圳のような代表都市イメージから、内陸の巨大製造業都市へ認識をずらす
...
- 日本語原稿を先に作る
- 英語字幕は日本語の行ごとに合わせる
- 英語は自然さよりも、編集時の同期を優先する
- 1文を長くしすぎない
- 抽象語だけで説明しない
- 「何を見たか」より「何に気づいたか」を中心にする
- 視聴者に教えるのではなく、一緒に見方が変わる構成にする
...
- 編集しやすさを優先する
- 意訳しすぎない
- 旅動画では、詩的すぎる英語よりも映像に合う簡潔な英語を優先する
...
### Vietnam
- 優しい笑顔の正体
- The gentle smile I saw in Vietnam

### Possible Format
- The truth behind the gentle smile
...
2. 印象に残った場面をメモ
3. Common Image を書く
4. Recognition Shift を書く
5. Concrete Observation を増やす
6. Deeper Insight に落とす
7. 日本との比較を入れる
8. 長めの原稿を作る
9. 不要な説明を削る
10. 日本語ナレーション確定
11. 英語字幕を行ごとに作る
12. Premiereで編集
13. Fable / Claudeで字幕整形
14. YouTube Shorts / Instagram投稿文作成
15. Obsidianに制作ログを残す
...
- Travel/Subtitles
- Travel/Titles
- Travel/Production Logs
- Travel/Country Notes
- Travel/Long Videos
- Travel/Shorts
...
## Key Insight
旅動画は、場所を紹介するものではない。  
自分の認識が変わった瞬間を、映像と言葉で共有するもの。

## Quote
Travel begins when a place changes the way you see the world.
